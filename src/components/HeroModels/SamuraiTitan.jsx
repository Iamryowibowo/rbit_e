...
Command: npx gltfjsx@6.5.3 samuraiTitan.glb 
...
export function Samurai(props) {
  ...
  const { nodes, materials } = useGLTF("/models/samuraiTitan.glb");
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <mesh geometry={nodes.Object_2.geometry} material={bodyMaterial} />
        <mesh
...
useGLTF.preload("/models/samuraiTitan.glb");
